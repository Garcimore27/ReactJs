...
export default function Contact() {
    ...
    // Cela servira a lier les variables (states) aux inputs et les mettre a jour en temps reel
    ...
    // Ici je crée ma fonction handleSubmit qui me permet de gérer l'envoi du formulaire
    // Que ce soit via le bouton envoyer ou en appuyant sur la touche Entrée du clavier
    // Je met le "e" en parametre de ma fonction pour récupérer l'evenement de l'envoi du formulaire
    const handleSubmit = (e) => {
        ...
        fetch("http://localhost:3001/contact", {
            ...
            headers: { // Nous pouvons egalement ajouter un objet dans les Headers afin de définir certaines informations
                // telle que le type de contenu, ou l'autorisation si nous avons une API sécurisée
                "Content-Type": "application/json",
            },
            // Enfin, nous allons définir le body de notre fetch
            // Cela va permettre de préciser quelles variable nous voulons envoyer à notre back-end
            ...
            //Apres l'envoi, je remets toutes mes variables à 0 afin de vider le formulaire
            setFirstName('')
            setLastName('')
            setEmail('')
            setMessage('')
    ...
    return (
        ...
        <form action="" onSubmit={handleSubmit}>
            ...
            {/* Pour chaques input, je définis value avec la variable qui lui est définie */}
            {/* J'ajoute aussi l'evenement onChange pour définir ma variable (state) à chaque changement de l'input */}
